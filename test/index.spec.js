...
describe('init function', () => {
    const testCases = [
        {
            service: 'assess',
            signature: '0969eed4ca4bf483096393d13ee1bae35b993e5204ab0f90cc80eaa055605295',
        ...
        {
            service: 'items',
            signature: '6c8fd9e76d43d5596b3216baf432f21cea5af3721dd7bd80dd1ff6426b38e052',
            outputString: '{"security":{"consumer_key":"yis0TYCu7U9V4o7M","domain":"localhost","timestamp":"20140626-0528","user_id":"demo_student","signature":"6c8fd9e76d43d5596b3216baf432f21cea5af3721dd7bd80dd1ff6426b38e052"},"request":{"user_id":"demo_student","rendering_type":"assess","name":"Items API demo - assess activity demo","state":"initial","activity_id":"items_assess_demo","session_id":"demo_session_uuid","type":"submit_practice","config":{"configuration":{"responsive_regions":true},"navigation":{"scrolling_indicator":true},"regions":"main","time":{"show_pause":true,"max_time":300},"title":"ItemsAPI Assess Isolation Demo","subtitle":"Testing Subtitle Text"},"items":["Demo3"]}}'
        },
        {
            service: 'questions',
            signature: '0969eed4ca4bf483096393d13ee1bae35b993e5204ab0f90cc80eaa055605295',
            outputString: '{"consumer_key":"yis0TYCu7U9V4o7M","timestamp":"20140626-0528","user_id":"demo_student","signature":"0969eed4ca4bf483096393d13ee1bae35b993e5204ab0f90cc80eaa055605295","type":"local_practice","state":"initial","questions":[{"response_id":"60005","type":"association","stimulus":"Match the cities to the parent nation.","stimulus_list":["London","Dublin","Paris","Sydney"],"possible_responses":["Australia","France","Ireland","England"],"validation":{"valid_responses":[["England"],["Ireland"],["France"],["Australia"]]}}]}'
        },
        {
            service: 'reports',
            signature: '217d82b0eb98b53e49f9367bed5a8c29d61e661946341c83cb2fcdbead78a8b2',
            outputString: '{"security":{"consumer_key":"yis0TYCu7U9V4o7M","domain":"localhost","timestamp":"20140626-0528","signature":"217d82b0eb98b53e49f9367bed5a8c29d61e661946341c83cb2fcdbead78a8b2"},"request":{"reports":[{"id":"report-1","type":"sessions-summary","user_id":"brianmoser","session_ids":["AC023456-2C73-44DC-82DA28894FCBC3BF"]}]}}'
        }
    ];
    ...
    describe('request validation', () => {
        ...
        describe('passing the request as a string', () => {
            const testCases = [
                ...
                {
                    service: 'items',
                    expected: '{"security":{"consumer_key":"yis0TYCu7U9V4o7M","domain":"localhost","timestamp":"20140626-0528","user_id":"demo_student","signature":"6c8fd9e76d43d5596b3216baf432f21cea5af3721dd7bd80dd1ff6426b38e052"},"request":"{\\"user_id\\":\\"demo_student\\",\\"rendering_type\\":\\"assess\\",\\"name\\":\\"Items API demo - assess activity demo\\",\\"state\\":\\"initial\\",\\"activity_id\\":\\"items_assess_demo\\",\\"session_id\\":\\"demo_session_uuid\\",\\"type\\":\\"submit_practice\\",\\"config\\":{\\"configuration\\":{\\"responsive_regions\\":true},\\"navigation\\":{\\"scrolling_indicator\\":true},\\"regions\\":\\"main\\",\\"time\\":{\\"show_pause\\":true,\\"max_time\\":300},\\"title\\":\\"ItemsAPI Assess Isolation Demo\\",\\"subtitle\\":\\"Testing Subtitle Text\\"},\\"items\\":[\\"Demo3\\"]}"}'
                }
            ];
